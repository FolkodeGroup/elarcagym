...
ssh -p 5371 root@168.197.49.120 'cd /opt/elarcagym && docker compose pull && docker compose up -d --force-recreate'
...
ssh -p 5371 root@168.197.49.120 'docker logs -f --tail 100 elarca-backend'

# Ver logs del frontend en producción
ssh -p 5371 root@168.197.49.120 'docker logs -f --tail 100 elarca-frontend'

# Reiniciar todos los servicios
ssh -p 5371 root@168.197.49.120 'cd /opt/elarcagym && docker compose restart'

# Ver estado de contenedores
ssh -p 5371 root@168.197.49.120 'docker ps'
```
